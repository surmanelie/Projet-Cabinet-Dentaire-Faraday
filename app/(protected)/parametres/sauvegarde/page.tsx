    ...
    <div className="max-w-2xl space-y-8">
      <div>
        ...
        <p className="mt-2 text-sm text-ardoise-500">
          Exportez l&apos;intégralité des données du cabinet dans un fichier JSON, ou restaurez-les à partir
          d&apos;une sauvegarde précédente. La restauration remplace toutes les données actuelles — une copie de
          sécurité de l&apos;état présent est automatiquement conservée avant tout remplacement.
        </p>
      </div>
